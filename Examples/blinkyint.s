...
Main:
  ...
  LDR     R4, =countdown
  LDR     R5, =BLINK_PERIOD
  STR     R5, [R4] // store blink period in memory to avoid it being altered during handler
...
SysTick_Handler:
  ...
  STR   R5, [R4]                    @ store new count back into memory
...
.LelseFire:                         @ else {
  ...
  LDR     R5, =BLINK_PERIOD         @
  STR     R5, [R4]                  @ reset countdown value back to 1000
...
countdown: //space for countdown variable
  .space  4
