  @ video link: https://tcdud-my.sharepoint.com/:v:/g/personal/olopadef_tcd_ie/Ed4MKWSSGpFBgKlVhvvn_FcBfEb45-_S24Ur-AvCa1fLuA?e=Js9pdw
  .syntax unified
  .cpu cortex-m4
  .thumb
  .global Main
...
@ PART TWO: remove systick handler
...
.LelseFire:                         @ else {
  ...
  @ PART ONE: uncomment down to EOR LD6

  LDR     R4, =GPIOD_ODR            @   Invert LD3

  LDR     R5, [R4]                  @

  @ commented out for part 3 (allowing green led blink independently)
...
@ PART ONE: remove exitI0 handler
@ PART TWO: include exitI0 handler
